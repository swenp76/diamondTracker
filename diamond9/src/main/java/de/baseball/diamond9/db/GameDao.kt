...
abstract class GameDao {
    ...
    @Query("UPDATE games SET date = :date, opponent = :opponent, game_time = :gameTime, is_home = :isHome, game_number = :gameNumber WHERE id = :gameId")
    abstract fun updateGame(gameId: Long, date: String, opponent: String, gameTime: String, isHome: Int, gameNumber: String)
