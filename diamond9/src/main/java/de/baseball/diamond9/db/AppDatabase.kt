...
abstract class AppDatabase : RoomDatabase() {
    ...
    abstract fun runnerAdvanceLogDao(): RunnerAdvanceLogDao
    ...
    companion object {
        ...
        private val MIGRATION_20_21 = object : Migration(20, 21) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE games ADD COLUMN is_locked INTEGER NOT NULL DEFAULT 0")
            }
        }

        private val MIGRATION_21_22 = object : Migration(21, 22) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE at_bats ADD COLUMN rbi INTEGER NOT NULL DEFAULT 0")
            }
        }
        ...
        private val MIGRATION_22_23 = object : Migration(22, 23) {
            override fun migrate(db: SupportSQLiteDatabase) {
                ...
                db.execSQL("CREATE INDEX IF NOT EXISTS index_runner_advances_game_id ON runner_advances(game_id)")
            }
        }

        private val MIGRATION_23_24 = object : Migration(23, 24) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE league_settings ADD COLUMN roll_over_enabled INTEGER NOT NULL DEFAULT 0")
            }
        }
